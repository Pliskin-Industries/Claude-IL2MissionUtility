...
- All six phases of README §9 are built (2026-09-24). `src/theme.rs` holds the tokens, fonts and visuals; `src/shell.rs` the rail, header, status bar and shared widgets. Build new UI on them. The README §10 backlog (a readiness checklist per tab) is not started.
